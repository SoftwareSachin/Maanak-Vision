        ...
        {products.map((p) => (
          <View key={p.id} style={S.productItem}>
            ...
            <View style={S.productActions}>
              {p.active ? (
                <View style={[S.activeChip, { borderColor: C.primary }]}>
                  <View style={[S.chipDot, { backgroundColor: C.primary }]} />
                  <Text style={[S.chipText, { color: C.primary }]}>Active</Text>
                </View>
              ) : (
                <Pressable
...
const S = StyleSheet.create({
  ...
  appBarTitle: { color: C.onSurface, fontSize: 22, fontFamily: "Rajdhani_600SemiBold", letterSpacing: 0.15 },
  appBarSub: { color: C.onSurfaceVariant, fontSize: 12, fontFamily: "Rajdhani_400Regular", marginTop: 1 },
  ...
  processingTitle: { color: C.onSurface, fontSize: 18, fontFamily: "Rajdhani_600SemiBold", letterSpacing: 0.15 },
  processingBody: { color: C.onSurfaceVariant, fontSize: 14, fontFamily: "Rajdhani_400Regular", textAlign: "center" },
  ...
  doneTitle: { color: C.onSurface, fontSize: 20, fontFamily: "Rajdhani_700Bold", letterSpacing: 0.15 },
  doneBody: { color: C.onSurfaceVariant, fontSize: 14, fontFamily: "Rajdhani_400Regular", textAlign: "center" },
  ...
  countBadgeText: { fontSize: 12, fontFamily: "Rajdhani_700Bold" },
  ...
  productName: { color: C.onSurface, fontSize: 14, fontFamily: "Rajdhani_500Medium", letterSpacing: 0.1 },
  productMeta: { color: C.onSurfaceVariant, fontSize: 12, fontFamily: "Rajdhani_400Regular" },
